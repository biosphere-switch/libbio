...
namespace bio::service::fsp {
    ...
    class FileSystem : public ipc::client::SessionObject {
        ...
        public:
            ...
            inline Result OpenFile(const char *path, u64 path_len, u32 flags, ipc::client::Session &out_file) {
                return this->session.SendSyncRequest<8>(ipc::client::In<u32>(flags), ipc::client::InStaticBuffer(path, path_len, 0), ipc::client::OutSession<0>(out_file));
            }
